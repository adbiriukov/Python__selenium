...
time.sleep(30)
good1 = driver.find_element_by_xpath('//*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[1]/div/div/div/div[1]/div[2]/div[1]/div')
print(good1.text)
price1 = driver.find_element_by_xpath('//*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[1]/div/div/div/div[1]/div[2]/div[3]/div[1]/div/text()')
print(price1.text)
...
# text
# //*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[1]/div/div/div/div[1]/div[2]/div[1]/div
# //*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[2]/div/div/div/div[1]/div[2]/div[1]/div
# price
# //*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[1]/div/div/div/div[1]/div[2]/div[3]/div[1]/div/text()
# //*[@id="view"]/div[1]/div/div[1]/div/div/div/section[2]/a[2]/div/div/div/div[1]/div[2]/div[3]/div[1]/div/text()
