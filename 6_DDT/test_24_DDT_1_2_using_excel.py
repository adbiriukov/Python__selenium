...
import test_24_DDT_1_1_using_Excel
import time

driver = webdriver.Chrome(executable_path="../chromedriver.exe")
driver.get("https://opensource-demo.orangehrmlive.com/")
driver.maximize_window()
path = "../files/xlsx_files/111.xlsx"

# Get row count
# Sheet1 is name if the sheet (page in excel)
row = test_24_DDT_1_1_using_Excel.getRowCount(path, "Sheet1")
for r in range(2, row+1):
    username = test_24_DDT_1_1_using_Excel.readData(path, "Sheet1", r, 1)  # 1 is column number where username
    password = test_24_DDT_1_1_using_Excel.readData(path, "Sheet1", r, 2)  # 2 is column number where we store password
    ...
    if driver.current_url == "https://opensource-demo.orangehrmlive.com/index.php/dashboard":
        ...
        test_24_DDT_1_1_using_Excel.writeData(path, "Sheet1", r, 3, "test passed")   # we pass data to the excel
        ...
        print('Test failed')
        test_24_DDT_1_1_using_Excel.writeData(path, "Sheet1", r, 3, "Test failed")
